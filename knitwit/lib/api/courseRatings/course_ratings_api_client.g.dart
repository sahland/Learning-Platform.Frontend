...
class _CourseRatingsApiClient implements CourseRatingsApiClient {
  ...
  @override
  Future<Ratings> getRatingsByUserId(int userId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'userId': userId};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result =
        await _dio.fetch<Map<String, dynamic>>(_setStreamType<Ratings>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = Ratings.fromJson(_result.data!);
    return value;
  }

  @override
  Future<Ratings> getCourseRatings(int courseId) async {
    final _extra = <String, dynamic>{};
